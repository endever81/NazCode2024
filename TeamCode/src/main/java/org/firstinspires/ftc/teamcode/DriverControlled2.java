...
public class DriverControlled2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        newLiftTargetV2 = robot.liftV2.getCurrentPosition();

        robot.liftH.setTargetPosition(newLiftTargetH);
        robot.liftV.setTargetPosition(newLiftTargetV);
        robot.liftV2.setTargetPosition(newLiftTargetV2);
...
// new code for Livy's Controller
            ...
            if (gamepad2.right_trigger > 0) {
                ...
                double leftStickXValue = gamepad2.left_stick_x;
                       leftStickXValue = (float)scaleInput(leftStickXValue);

            // Calculate swing arm angle (60° to 240° range)
                double swingAngle = 150 + (leftStickXValue * 85); // Center at 150°, ±90°
