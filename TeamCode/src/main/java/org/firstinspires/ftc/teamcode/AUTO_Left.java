...
public class AUTO_Left extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder toSamples = drive.actionBuilder(toSubEnd)
                ...
                .splineToSplineHeading(new Pose2d(-18,-5, Math.toRadians(-90)), Math.toRadians(90))
                .strafeTo(new Vector2d(-26.5, -5))
                //Push in Sample 1
                .strafeTo(new Vector2d(-26.5, -50))// push sample to wall
                .strafeTo(new Vector2d(-26.5, -15))// bak up
                .strafeTo(new Vector2d(-32, -15)) // move over to sample 2
                //Push in Sample 2
                .strafeTo(new Vector2d(-32, -50))// push sample to wall
                .strafeToLinearHeading(new Vector2d(-32, -15),Math.toRadians(160))
                .strafeToLinearHeading(new Vector2d(-18, -15),Math.toRadians(70));
               // .waitSeconds(30)
              //  .strafeTo(new Vector2d(-32, -10)) // backup
        ...
        Pose2d toSamplesEnd = new Pose2d(-18, -15, Math.toRadians(70));
